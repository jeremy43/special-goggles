...
# Modified by Xizhou Zhu, Yuwen Xiong, Yuqing Zhu, Shuhao Fu
# --------------------------------------------------------
...
def pred_eval(gpu_id, feat_predictors, aggr_predictors, test_data, imdb, cfg, vis=False, thresh=1e-3, logger=None, ignore_cache=True):
    ...
    roidb_offset = -1
    idx = 0
    video_idx = 0       #video_idx infers the video_idx-th video
    last_idx = 0  # last_idx records the end of last video
